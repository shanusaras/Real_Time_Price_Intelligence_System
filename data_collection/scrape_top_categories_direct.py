...
# Top 5 hottest business-relevant categories
CATEGORIES = [
    "snacks",
    "beverages",
    "dairies",
...
OUTPUT_PATH = os.path.join(DATA_DIR, 'top_categories_direct_scrape.json')
LOG_PATH = os.path.join(DATA_DIR, 'scrape_top_categories_direct.log')
